 ...
 */
final class Version20200830104832 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE matche (id INT AUTO_INCREMENT NOT NULL, home_team_id INT NOT NULL, visitor_team_id INT NOT NULL, home_team_goal INT DEFAULT NULL, visitor_team_goal INT DEFAULT NULL, date DATETIME DEFAULT NULL, match_day INT DEFAULT NULL, is_over TINYINT(1) NOT NULL, appointment_hour TIME DEFAULT NULL, INDEX IDX_9FCAD5109C4C13F6 (home_team_id), INDEX IDX_9FCAD510EB7F4866 (visitor_team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
        ...
        $this->addSql('CREATE TABLE un_official_match (id INT AUTO_INCREMENT NOT NULL, team_ronvau_id INT NOT NULL, opponent_id INT NOT NULL, ronvau_team_goal INT DEFAULT NULL, opponent_goal INT DEFAULT NULL, date DATETIME NOT NULL, is_home TINYINT(1) NOT NULL, is_over TINYINT(1) NOT NULL, appointment_hour TIME DEFAULT NULL, INDEX IDX_D96856CAE1D39818 (team_ronvau_id), INDEX IDX_D96856CA7F656CDC (opponent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');

        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, email VARCHAR(180) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, roles LONGTEXT NOT NULL, password VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, first_name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, last_name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, gsm VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, profile_pic VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, is_accepted TINYINT(1) NOT NULL, token_mobile VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, rgpd TINYINT(1) NOT NULL, rgpd_date DATETIME DEFAULT NULL, rgpd_visible_staff TINYINT(1) NOT NULL, rgpd_visible_all TINYINT(1) NOT NULL, last_connection DATETIME DEFAULT NULL, rgdp_photos TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
