 ...
 */
final class Version20200319222907 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team ADD club_id INT NOT NULL, ADD competition_id INT NOT NULL, DROP id_club_id, DROP id_competition_id, CHANGE played played INT DEFAULT 0 NOT NULL, CHANGE drawn drawn INT DEFAULT 0 NOT NULL, CHANGE lost lost INT DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team ADD id_club_id INT NOT NULL, ADD id_competition_id INT NOT NULL, DROP club_id, DROP competition_id, CHANGE played played INT NOT NULL, CHANGE drawn drawn INT NOT NULL, CHANGE lost lost INT NOT NULL');
