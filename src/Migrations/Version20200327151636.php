 ...
 */
final class Version20200327151636 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_7A5BC505EB7F4866 ON `match`');
        $this->addSql('ALTER TABLE `match` DROP visitor_team_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `match` ADD visitor_team_id INT NOT NULL');
        $this->addSql('ALTER TABLE `match` ADD CONSTRAINT FK_7A5BC505EB7F4866 FOREIGN KEY (visitor_team_id) REFERENCES team (id)');
        $this->addSql('CREATE INDEX IDX_7A5BC505EB7F4866 ON `match` (visitor_team_id)');
    }
}
